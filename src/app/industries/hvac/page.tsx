  ...
  return (
    <>
      ...
      <section className="py-20 bg-surface-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            title="How RingCrew Works for HVAC Companies"
            centered
          />
            ...
            <Card className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Tell us about your HVAC services, pricing, hours, and emergency protocols. Takes 3 minutes.
                  </p>
                </div>
              </div>
            </Card>
            <Card className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We train your AI agent on your HVAC business. It knows tune-ups from replacements, heat from AC.
                  </p>
                </div>
              </div>
            </Card>
            <Card className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Every HVAC service call is answered in under 1 second. Emergency calls transfer immediately.
                  </p>
                </div>
              </div>
            </Card>
      ...
      <section className="py-20 bg-brand-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6">
            Ready to Stop Missing HVAC Service Calls?
          </h2>
          <p className="text-xl mb-8 text-brand-100">
            Join HVAC companies capturing $12K+ in monthly revenue with RingCrew.
          </p>
          <Button asChild size="lg" className="bg-white text-brand-800 hover:bg-gray-100">
            <Link href={`/get-started?industry=${industry.slug}`}>
              Get Started Free — Built for HVAC
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </Button>
